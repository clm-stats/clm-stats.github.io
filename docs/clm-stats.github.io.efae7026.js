...
})({"eODSk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "85e8c2feefae7026";
"use strict";
...
var _clmstats = require("./CLMStats");
var _clmstatsDefault = parcelHelpers.interopDefault(_clmstats);
...
let el;
{
    ...
    window.periodFuture = fetch(`/db/periods/${_util.getPeriodId(urlParams.get('season'))}.json`).then(function(res) {
        return res.json();
    });
    el = (0, _preact.h)((0, _clmstats.PureCLMStats), {
        U: ()=>{
            function urlHrefMk() {
                ...
                return base + _util.mkQs(_util.resolveSort(sort));
            }
            function urlMk({ season, page, sort } = {}) {
                ...
                return '/' + _util.mkQs(_util.resolveSort(sort), intoQs);
            }
...
}(0, _preact.render)(el, container);

},{"preact":"agj7k","./CLMStats":"7P7Pb","./util":"hiwg4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"agj7k":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"7P7Pb":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$94cf = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$94cf.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$94cf.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PureCLMStats", ()=>PureCLMStats);
parcelHelpers.export(exports, "default", ()=>CLMStats);
...
function cnActive(b) {
    return b ? cnActiveTrue : cnActiveFalse;
}
class CtxClass {
    ...
    getSortedImpl() {
        ...
        res.sort(sortFn);
        if (this.sort.dir !== 'asc') res.reverse();
        return res;
    }
    get sorted() {
    ...
    get isInitialSortDir() {
        return this.sort.dir === _util.getDefaultDir(this.sort.by);
    }
    get sort() {
    ...
    get isLoadingPeriod() {
        return this.state.isLoadingPeriod;
    }
    get href() {
        return this.state.href;
    }
    get page() {
        return _util.resolvePageStr(this.state.page);
    }
    get season() {
        return _util.getSeason(this.periodId);
    }
    get periodId() {
        return this.state.periodId || _util.timeline.current;
    }
    get periodTitle() {
        return _util.Period(this.periodId).title;
    }
    get isHamburgerOpen() {
        return !!this.state.isHamburgerOpen;
    }
    get isSideNavOpen() {
        return !!this.state.isSideNavOpen;
    }
    get cnBurgerActive() {
        return cnActive(this.isHamburgerOpen);
    }
    get orgTree() {
    ...
    mergeState(props) {
        if (props.period && props.period !== this.state.period) this.sorts = {};
        this.setState({
            ...this.state,
            ...props
        });
    ...
    hPeriod(periodId) {
        return this.urlMk({
            season: _util.getSeason(periodId),
            page: this.page
        });
    }
    hPage(page) {
    ...
    character(playerIdent) {
        ...
        return _util.lkupChar(player.name);
    }
    onHref(href) {
        if (href !== window.location.href) {
            ...
            const periodId = _util.resolveSeasonStr((parts || [])[1]);
            const page = _util.resolvePageStr((parts || [])[2]);
            const isLoadingPeriod = periodId !== this.state.periodId;
            const period = isLoadingPeriod ? null : this.state.period;
            const sort = {
                dir: _util.resolveSortDir(url.searchParams.get('dir')),
                by: _util.resolveSortBy(url.searchParams.get('by'))
            };
...
const Ctx = (0, _preact.createContext)({});
function useCtx() {
    return (0, _hooks.useContext)(Ctx);
}
function Link(props) {
    const X = useCtx();
    function onClick(e) {
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("a", {
        ...
        fileName: "js/CLMStats.jsx",
        lineNumber: 146,
        columnNumber: 5
    }, this);
}
function NavBarLink({ href, children, iht = false, ia = false }) {
    const className = (0, _classnamesDefault.default)('navbar-item', {
        'is-hidden-touch navbar-item': iht,
        'is-selected': ia
    });
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Link, {
                                ...
                                children: [
                                    ...
                                    "\xa0\xa0\xa0 Hide Out of Region Players"
                                ]
                            }, void 0, true, {
                                fileName: "js/CLMStats.jsx",
                                lineNumber: 235,
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("label", {
                            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Link, {
                                ...
                                children: [
                                    ...
                                    "\xa0\xa0\xa0 Hide PR Ineligible Players"
                                ]
                            }, void 0, true, {
                                fileName: "js/CLMStats.jsx",
                                lineNumber: 246,
        ...
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                            className: "has-text-info is-hidden-touch",
                            children: X.periodTitle
                        }, void 0, false, {
                            fileName: "js/CLMStats.jsx",
                            lineNumber: 268,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                            className: "has-text-info is-hidden-desktop",
                            children: NF("\uEAB0")
                        }, void 0, false, {
                            fileName: "js/CLMStats.jsx",
                            lineNumber: 271,
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    className: "dropdown-content",
                    children: _util.timeline.periods.map(({ periodId, title })=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Link, {
                            href: X.hPeriod(periodId),
                            className: (0, _classnamesDefault.default)('dropdown-item', {
                                'is-active': periodId === X.periodId
                            }),
                            children: title
                        }, periodId, false, {
                            fileName: "js/CLMStats.jsx",
...
function THCell({ className, by, text, justifyContent }) {
    ...
    const sym = !isActive ? "\uF0DC" : isAsc ? "\uF0DE" : "\uF0DD";
    const nextDir = !isActive ? _util.getDefaultDir(by) : isAsc ? 'desc' : 'asc';
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("th", {
        className: (0, _classnamesDefault.default)('is-clipped', className || ''),
        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PreSized, {
            width: "0",
            justifyContent: justifyContent,
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Link, {
                className: (0, _classnamesDefault.default)('has-text-strong', {
                    'is-underlined': isActive
                }),
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                                className: "next-sort is-overlay is-flex",
                                children: NF(nextDir === 'asc' ? "\uF0DE" : "\uF0DD")
                            }, void 0, false, {
                                fileName: "js/CLMStats.jsx",
                                lineNumber: 317,
                                columnNumber: 13
...
function MenuBar() {
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("nav", {
        className: "navbar is-fixed-top container is-max-widescreen",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                className: "navbar-brand is-flex-grow-1",
                children: [
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(NavBarLink, {
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Search, {}, void 0, false, {
                            fileName: "js/CLMStats.jsx",
                            lineNumber: 342,
                            columnNumber: 11
                        }, this)
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        children: [
                            " ",
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Periods, {}, void 0, false, {
                                fileName: "js/CLMStats.jsx",
                                lineNumber: 345,
                                columnNumber: 94
                            }, this),
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("a", {
                        role: "button",
                        className: (0, _classnamesDefault.default)('navbar-burger', X.cnBurgerActive),
                        "aria-label": "menu",
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                ...
                className: (0, _classnamesDefault.default)('navbar-menu', X.cnBurgerActive),
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    className: "navbar-start is-hidden-desktop",
                    children: [
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(NavBarLink, {
                            ia: X.page === 'stats',
                            href: X.hPage('stats'),
...
function ProfileImage(props) {
    const [hasError, setHasError] = (0, _hooks.useState)(false);
    const className = (0, _classnamesDefault.default)(props.className || '', {
        defaultProfile: hasError
    });
...
function PureRow(props) {
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tr", {
        className: (0, _classnamesDefault.default)('rel', colorClass),
        children: [
                        ...
                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                            className: "nowrap has-text-weight-bold is-size-5",
                                            children: props.name
                                        }, void 0, false, {
                                            fileName: "js/CLMStats.jsx",
                                            lineNumber: 451,
                                        ...
                                        !props.pronouns ? null : /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("td", {
                className: "py-6 nowrap has-text-centered",
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PreSized, {
                    width: "5.625rem",
                    children: props.qual
                }, void 0, false, {
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("td", {
                className: "nowrap has-text-centered",
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PreSized, {
                    width: "5.625rem",
                    children: props.acc
                }, void 0, false, {
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("td", {
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PreSized, {
                    width: "5.625rem",
                    children: canClmPr ? props.att : /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        className: "dropdown is-hoverable is-right",
                        children: [
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                className: "dropdown-trigger is-italic",
                                children: [
                                    props.att,
                                    "*"
                                ]
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                ...
                                role: "menu",
                                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                    className: "dropdown-content box",
                                    children: noPrReason
                                }, void 0, false, {
                                    fileName: "js/CLMStats.jsx",
                                    lineNumber: 483,
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PreSized, {
                    ...
                    children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                                className: "nowrap has-text-weak",
                                children: props.mruDate
                            }, void 0, false, {
                                fileName: "js/CLMStats.jsx",
                                lineNumber: 501,
                                columnNumber: 13
...
function StatsTable() {
    const X = useCtx();
    const skelEl = /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PureRow, {
        ord: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
            className: "button is-skeleton"
        }, void 0, false, {
            fileName: "js/CLMStats.jsx",
            lineNumber: 518,
            columnNumber: 13
        ...
        name: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        pronouns: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
            className: "tag is-skeleton",
            children: "pronouns"
        }, void 0, false, {
            fileName: "js/CLMStats.jsx",
            lineNumber: 521,
        ...
        character: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
            className: "icon is-skeleton",
            children: "c"
        }, void 0, false, {
            fileName: "js/CLMStats.jsx",
            lineNumber: 522,
        ...
        qual: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "skeleton-lines",
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {}, void 0, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 523,
        ...
        acc: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "skeleton-lines",
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {}, void 0, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 524,
        ...
        att: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "skeleton-lines",
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {}, void 0, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 525,
        ...
        mruLink: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "skeleton-lines",
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {}, void 0, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 526,
        ...
        mruPlacing: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
            className: "tag is-skeleton",
            children: "placing"
        }, void 0, false, {
            fileName: "js/CLMStats.jsx",
        ...
        mruDate: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
            className: "tag is-skeleton",
            children: "date"
        }, void 0, false, {
            fileName: "js/CLMStats.jsx",
    ...
    const skel = /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tbody", {
        children: [
            skelEl,
            skelEl,
            skelEl,
    ...
    const el = (X.isLoadingPeriod ? ()=>skel : ()=>{
        ...
        const rows = filtered.map((rank, nth)=>{
            ...
            const defaultProfile = player.image === defaultProfileImage;
            return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PureRow, {
                ord: X.isInitialSortDir ? nth + 1 : filtered.length - nth,
                profileImage: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(ProfileImage, {
                    src: player.image,
                    className: (0, _classnamesDefault.default)({
                        defaultProfile
                    }),
                    loading: "lazy",
                ...
                character: !character ? null : /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("img", {
                    style: {
                        height: '1.25rem',
                        width: '1.25rem'
                    },
                ...
                att: rank.prEvents || 0,
                mruLink: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("a", {
                    className: "nowrap",
                    href: `https://start.gg/${event.slug}`,
                    children: event.tournamentName
                }, void 0, false, {
                    fileName: "js/CLMStats.jsx",
                    lineNumber: 579,
                    columnNumber: 13
                ...
                mruDate: dstr,
                isOutOfRegion: !_util.inRegion(rank.playerIdent),
                isIneligible: !X.doesMeetActivity(rank)
            }, rank.playerIdent, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 556,
                columnNumber: 9
            }, this);
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "is-flex-grow-1 is-flex is-flex-direction-column is-align-items-stretch rel",
        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("thead", {
                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tr", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(THCell, {
                                    by: "name",
                                    text: "Player",
                                    justifyContent: "start"
                                }, void 0, false, {
...
function Body() {
    const X = useCtx();
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "section p-0 is-flex-grow-1 is-flex is-flex-direction-column",
        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "container is-flex-grow-1 is-flex is-flex-direction-column",
            children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(StatsTable, {}, void 0, false, {
                fileName: "js/CLMStats.jsx",
                lineNumber: 638,
                columnNumber: 9
            }, this)
...
function PureCLMStats(props) {
    ...
    if (!pageLoadData.isDone) {
        ...
        const hrefPath = url.pathname;
        const parts = /^\/([a-z0-9_\-]+)\/([a-z0-9]+)(\.html)?$/.exec(hrefPath.toLowerCase());
        const urlPeriod = _util.resolveSeasonStr((parts || [])[1]);
        const urlPage = _util.resolvePageStr((parts || [])[2]);
    ...
    const [state, _setState] = (0, _hooks.useState)(initialState);
    ...
    ctx.state = state;
    (0, _hooks.useEffect)(()=>{
        if (state.after) state.after().then((ups)=>setState({
                ...__state,
                ...ups
            }));
    }, [
    ...
    (0, _hooks.useEffect)(()=>{
        mkPeriodFuture().then((period)=>ctx.mergeState({
                period,
                isLoadingPeriod: false
            })).catch((error)=>ctx.mergeState({
                error
            }));
    }, []);
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(Ctx.Provider, {
        value: ctx,
        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            className: "container px-0 box is-max-widescreen is-flex is-flex-direction-column",
            children: [
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(MenuBar, {}, void 0, false, {
                    fileName: "js/CLMStats.jsx",
                    lineNumber: 692,
                    columnNumber: 9
                }, this),
...
function CLMStats() {
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)(PureCLMStats, {
        U: Uval
    }, void 0, false, {
        fileName: "js/CLMStats.jsx",
        lineNumber: 715,
  ...
  $parcel$ReactRefreshHelpers$94cf.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"kvPQf","preact":"agj7k","preact/hooks":"83L4j","classnames":"Egwmr","./util":"hiwg4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}],"kvPQf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"preact/compat":"cjkvk","preact/jsx-runtime":"jBtcg","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cjkvk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "isElement", ()=>Rn);
parcelHelpers.export(exports, "isFragment", ()=>pn);
parcelHelpers.export(exports, "isMemo", ()=>yn);
parcelHelpers.export(exports, "isValidElement", ()=>mn);
parcelHelpers.export(exports, "lazy", ()=>z);
parcelHelpers.export(exports, "memo", ()=>M);
parcelHelpers.export(exports, "render", ()=>nn);
parcelHelpers.export(exports, "startTransition", ()=>x);
...
var gn = function(n, t) {
    ...
    return n(t);
}, Cn = (0, _preact.Fragment), Rn = mn, xn = {
    useState: (0, _hooks.useState),
    useId: (0, _hooks.useId),
    useReducer: (0, _hooks.useReducer),
    useEffect: (0, _hooks.useEffect),
...
},{"preact":"agj7k","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jBtcg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Fragment", ()=>(0, _preact.Fragment));
...
},{"preact":"agj7k","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"Egwmr":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"hiwg4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PageTypes", ()=>PageTypes);
parcelHelpers.export(exports, "timeline", ()=>timeline);
parcelHelpers.export(exports, "resolveSortBy", ()=>resolveSortBy);
parcelHelpers.export(exports, "getDefaultDir", ()=>getDefaultDir);
parcelHelpers.export(exports, "resolveSortDir", ()=>resolveSortDir);
parcelHelpers.export(exports, "resolveSeasonStr", ()=>resolveSeasonStr);
parcelHelpers.export(exports, "defaultPage", ()=>defaultPage);
parcelHelpers.export(exports, "resolvePageStr", ()=>resolvePageStr);
parcelHelpers.export(exports, "getSeason", ()=>getSeason);
parcelHelpers.export(exports, "getPeriodId", ()=>getPeriodId);
parcelHelpers.export(exports, "Period", ()=>Period);
parcelHelpers.export(exports, "inRegion", ()=>inRegion);
parcelHelpers.export(exports, "lkupChar", ()=>lkupChar);
parcelHelpers.export(exports, "mkQs", ()=>mkQs);
parcelHelpers.export(exports, "resolveSort", ()=>resolveSort);
parcelHelpers.export(exports, "resolveFilter", ()=>resolveFilter);
parcelHelpers.export(exports, "toFilterString", ()=>toFilterString);
var _timelineJson = require("./timeline.json");
var _timelineJsonDefault = parcelHelpers.interopDefault(_timelineJson);
const PageTypes = [
    'stats',
    'players',
    'compare',
...
const timeline = {
    ...(0, _timelineJsonDefault.default)
};
timeline.periods = [
    ...(0, _timelineJsonDefault.default).periods
];
...
function resolveSortBy(str) {
    return SORT_BYS.has(str) ? str : defaultSortBy;
}
function getDefaultDir(by) {
    return ({
        ord: 'asc',
        name: 'asc',
        qual: 'desc',
...
const SORT_DIRS = new Set([
    'asc',
    'desc'
]);
const defaultSortDir = 'desc';
function resolveSortDir(str) {
...
function inRegion(player) {
    return !OUT_OF_REGION.has(player);
}
function lkupChar(player) {
...
},{"./timeline.json":"3kF68","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3kF68":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse("{\"current\":13,\"periods\":[{\"periodId\":10,\"title\":\"2024 Act III\",\"season\":\"chicago_2024-3\"},{\"periodId\":11,\"title\":\"2025 Act I\",\"season\":\"chicago_2025-1\"},{\"periodId\":12,\"title\":\"2025 Act II\",\"season\":\"chicago_2025-2\"},{\"periodId\":13,\"title\":\"2025 Act III\",\"season\":\"chicago_2025-3\"},{\"periodId\":2,\"title\":\"2022 Spring\",\"season\":\"chicago_2022-2\"},{\"periodId\":3,\"title\":\"2022 Summer\",\"season\":\"chicago_2022-3\"},{\"periodId\":4,\"title\":\"2022 Fall\",\"season\":\"chicago_2022-4\"},{\"periodId\":5,\"title\":\"2023 Act I\",\"season\":\"chicago_2023-1\"},{\"periodId\":6,\"title\":\"2023 Act II\",\"season\":\"chicago_2023-2\"},{\"periodId\":7,\"title\":\"2023 Act III\",\"season\":\"chicago_2023-3\"},{\"periodId\":8,\"title\":\"2024 Act I\",\"season\":\"chicago_2024-1\"},{\"periodId\":9,\"title\":\"2024 Act II\",\"season\":\"chicago_2024-2\"}]}");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["eODSk","iIYEz"], "iIYEz", "parcelRequire027d", {}, null, null, "http://localhost:1234")

//# sourceMappingURL=clm-stats.github.io.efae7026.js.map
